...
(cl:defmethod cl:initialize-instance :after ((m <Telemetry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Telemetry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name au_uav_gui-msg:<Telemetry> is deprecated: use au_uav_gui-msg:Telemetry instead.")))
...
(cl:defmethod airSpeed-val ((m <Telemetry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader au_uav_gui-msg:airSpeed-val is deprecated.  Use au_uav_gui-msg:airSpeed instead.")
  (airSpeed m))
