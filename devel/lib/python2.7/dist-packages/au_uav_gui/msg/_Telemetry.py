"""autogenerated by genpy from au_uav_gui/Telemetry.msg. Do not edit."""
import sys
...
class Telemetry(genpy.Message):
  _md5sum = "ed327d31082684850bc15716fdc27fdf"
  _type = "au_uav_gui/Telemetry"
...
"""
  __slots__ = ['telemetryHeader','planeID','currentLatitude','currentLongitude','currentAltitude','destLatitude','destLongitude','destAltitude','groundSpeed','airSpeed','targetBearing','currentWaypointIndex','distanceToDestination']
  _slot_types = ['std_msgs/Header','int32','float64','float64','float64','float64','float64','float64','float64','float64','float64','int64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       telemetryHeader,planeID,currentLatitude,currentLongitude,currentAltitude,destLatitude,destLongitude,destAltitude,groundSpeed,airSpeed,targetBearing,currentWaypointIndex,distanceToDestination
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_i9dqd.pack(_x.planeID, _x.currentLatitude, _x.currentLongitude, _x.currentAltitude, _x.destLatitude, _x.destLongitude, _x.destAltitude, _x.groundSpeed, _x.airSpeed, _x.targetBearing, _x.currentWaypointIndex, _x.distanceToDestination))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.planeID, _x.currentLatitude, _x.currentLongitude, _x.currentAltitude, _x.destLatitude, _x.destLongitude, _x.destAltitude, _x.groundSpeed, _x.airSpeed, _x.targetBearing, _x.currentWaypointIndex, _x.distanceToDestination,) = _struct_i9dqd.unpack(str[start:end])
      return self
...
_struct_i9dqd = struct.Struct("<i9dqd")
