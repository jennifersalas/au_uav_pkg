...
namespace au_uav_ros{
	...
	private:
		...
		ros::ServiceServer receiveAckService;

		ros::Timer resendCommandTimer;
	...
	public:
		...
		void sendCommandMessage(const au_uav_ros::Command &cmd);
		...
		bool ack_received(Ack::Request &req, Ack::Response &res);
		void resendCommands(const ros::TimerEvent& event);
	};
}
#endif
