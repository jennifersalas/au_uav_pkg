...
static void mavlink_test_au_uav(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_au_uav_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.au_airspeed = packet_in.au_airspeed;
	...
	mavlink_msg_au_uav_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_au_uav_pack(system_id, component_id, &msg , packet1.au_lat , packet1.au_lng , packet1.au_alt , packet1.au_target_lat , packet1.au_target_lng , packet1.au_target_alt , packet1.au_ground_speed , packet1.au_airspeed , packet1.au_target_bearing , packet1.au_distance , packet1.au_target_wp_index );
	mavlink_msg_au_uav_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_au_uav_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.au_lat , packet1.au_lng , packet1.au_alt , packet1.au_target_lat , packet1.au_target_lng , packet1.au_target_alt , packet1.au_ground_speed , packet1.au_airspeed , packet1.au_target_bearing , packet1.au_distance , packet1.au_target_wp_index );
	mavlink_msg_au_uav_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_au_uav_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_au_uav_send(MAVLINK_COMM_1 , packet1.au_lat , packet1.au_lng , packet1.au_alt , packet1.au_target_lat , packet1.au_target_lng , packet1.au_target_alt , packet1.au_ground_speed , packet1.au_airspeed , packet1.au_target_bearing , packet1.au_distance , packet1.au_target_wp_index );
	mavlink_msg_au_uav_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
